package Data;
/**
 * Contient l'ensemble des tables de substitutions S
 */
public class TableS {
    ...
    private static int[] S8 = {13,2,8,4,6,15,11,1,10,9,3,15,5,0,12,7,
    ...
    private static int[][] tables = {S1,S2,S3,S4,S5,S6,S7,S8};

    
    /** 
     * Récupère la table de permutation Sn
     * @param numéro numéro de la table 
     * @return int[]
     */
    public static int[] getTables(int numéro) {
